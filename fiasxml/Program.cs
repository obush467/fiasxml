...
namespace fias
{
    class Program
    {
        ...
        public static string DBF_Directory = "C:\\Users\\PEG1\\Downloads\\Compressed\\fias_dbf";
        ...
        private static fias_DBF_to_dataset fiasDBFDataSetConverter = new fias_DBF_to_dataset(new DirectoryInfo(DBF_Directory),connection);
